...
export class InitialMigration1693893921387 implements MigrationInterface {
    name = 'InitialMigration1693893921387'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "contents" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(150) NOT NULL, "content" text NOT NULL, "video_url" character varying(200) NOT NULL, "courseId" uuid, CONSTRAINT "PK_b7c504072e537532d7080c54fac" PRIMARY KEY ("id"))`);
